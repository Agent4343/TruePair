...
async function seedOnboardingQuestions() {
    const questions = [
        {
            category: client_1.QuestionCategory.VALUES,
            questionText: 'What role does honesty play in your relationships?',
            questionType: client_1.QuestionType.FREE_TEXT,
            order: 1,
        ...
        },
        {
            ...
            questionType: client_1.QuestionType.RANKING,
            options: {
        ...
        {
            category: client_1.QuestionCategory.LIFESTYLE,
        ...
        {
            category: client_1.QuestionCategory.RELATIONSHIP_GOALS,
        ...
        {
            category: client_1.QuestionCategory.COMMUNICATION,
        ...
        {
            category: client_1.QuestionCategory.BEHAVIOR_SCENARIO,
            questionText: "Your partner shares something they're insecure about. What do you do?",
            questionType: client_1.QuestionType.SCENARIO,
        ...
        {
            category: client_1.QuestionCategory.BOUNDARIES,
            questionText: 'What are your non-negotiable boundaries in a relationship?',
            questionType: client_1.QuestionType.FREE_TEXT,
            order: 1,
        },
        {
            category: client_1.QuestionCategory.COMMITMENT,
...
async function seedUsers() {
    ...
    const userData = [
        {
            ...
            profile: {
                ...
                genderPreferences: [client_1.Gender.FEMALE],
                city: 'San Francisco',
                state: 'CA',
                country: 'USA',
                latitude: 37.7749,
                ...
                relationshipIntent: client_1.RelationshipIntent.LONG_TERM,
        ...
        },
        {
            ...
            profile: {
                ...
                genderPreferences: [client_1.Gender.MALE],
                city: 'San Francisco',
                state: 'CA',
                country: 'USA',
                latitude: 37.7849,
        ...
        },
        {
            ...
            profile: {
                ...
                gender: client_1.Gender.FEMALE,
                genderPreferences: [client_1.Gender.MALE, client_1.Gender.NON_BINARY],
                city: 'Berkeley',
                state: 'CA',
                country: 'USA',
                latitude: 37.8716,
    ...
    for (const data of userData) {
        ...
        const signals = [client_1.SafetySignalType.VERIFIED_PHOTO, client_1.SafetySignalType.VERIFIED_EMAIL];
        if (Math.random() > 0.5) {
            signals.push(client_1.SafetySignalType.RESPONSIVE_COMMUNICATOR);
        }
...
async function seedMatchesAndMessages(users) {
